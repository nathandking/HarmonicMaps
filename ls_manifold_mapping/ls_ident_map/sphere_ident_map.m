%% Computation of identity map for a sphere from an initial noisy map.
...
for j = 1:num_rep
    for i = 1:length(dx)    
        ...
        proj_M = blkdiag(proj_M2{:});
         ...
         F = scatteredInterpolant(xg, yg, zg, sd, 'linear');
        ...
        for kt = 1:numtimesteps
            ...
            % project onto sphere N
%            [~,~,~,sd_new] = cpSphere(u1, u2, u3);
            sd_new = F(u1, u2, u3);
